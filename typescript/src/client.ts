/**
 * Unofficial TypeScript client — Amana / Union / Cargills Bank rates & offers
 *
...
export class AmanaUnionCargillsBankDocsClient {
  ...
  static readonly slug = "amana-union-cargills-bank-docs";
  static readonly title = "Amana / Union / Cargills Bank rates & offers";
   ...
   */
  async amanaRates(options: RequestOptions = {}): Promise<unknown> {
    return this.requestJson<unknown>(this.resolveUrl("https://www.amanabank.lk/rates/", options.query), { ...options, method: "GET" });
  }
   ...
   */
  async unionBankOffers(options: RequestOptions = {}): Promise<unknown> {
    return this.requestJson<unknown>(this.resolveUrl("https://www.unionb.com/personal/cards/offers", options.query), { ...options, method: "GET" });
  }
   ...
   */
  async cargillsBankRates(options: RequestOptions = {}): Promise<unknown> {
    return this.requestJson<unknown>(this.resolveUrl("https://www.cargillsbank.com/rates-and-tariffs/", options.query), { ...options, method: "GET" });
  }
}
